...
3.  **Logical Clinical Problem Solving (LCPS)**:
    ...
    - 定義 **Location & Lesion**：使用 [clinical_reasoning_logic.md](references/clinical_reasoning_logic.md) 的 **DAMNIT-V** 邏輯。
4.  **Data Capture**:
...
- "要執行 **`/ddx-generator`** (生成鑑別診斷清單) 嗎？"
- "要預覽目前的 **SOAP** 草稿 (執行 **gen-soap**) 嗎？"
- "需要撰寫 **discharge_summary** (出院摘要範本) 嗎？"

## 📝 Key Reference Files
- [references/comprehensive_history.md](references/comprehensive_history.md)
- [references/clinical_reasoning_logic.md](references/clinical_reasoning_logic.md)
